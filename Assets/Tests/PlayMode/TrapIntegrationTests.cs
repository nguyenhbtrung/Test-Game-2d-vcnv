...
public class TrapIntegrationTests
{
    ...
    public IEnumerator Test2()
    {
        ...
        var player = GameObject.Find("End (Pressed) (64x64)_0");
        ...
        Assert.Pass($"colliderSize.x: {colliderSize.x}, spriteSize.x: {spriteSize.x} \nwidthRatio: {widthRatio}, heightRatio: {heightRatio} \noffsetRatioX: {offsetRatioX}, offsetRatioY: {offsetRatioY}");
    }
